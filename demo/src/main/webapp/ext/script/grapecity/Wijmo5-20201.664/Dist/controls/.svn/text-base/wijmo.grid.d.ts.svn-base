...
declare module wijmo.grid {
    ...
    class FlexGrid extends wijmo.Control {
        ...
        */
         ...
         * {@link Column} objects, plus two optional members:
         *
         * * 'columns' member containing an array of child columns,
         * * 'collapseTo' member containing the binding of the child column
...
declare module wijmo.grid {
    ...
    class _MouseHandler {
        ...
        _getResizeCol(panel: GridPanel, index: number): Column;
        _getResizeRow(panel: GridPanel, index: number): Row;
