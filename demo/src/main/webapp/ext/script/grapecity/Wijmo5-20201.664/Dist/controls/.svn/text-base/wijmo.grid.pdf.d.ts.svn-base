...
declare module wijmo.grid.pdf {
    ...
    class PdfFormatItemEventArgs extends /*wijmo.grid.CellRangeEventArgs*/ wijmo.CancelEventArgs {
         ...
         */
        constructor(p: any, rng: any, cell: HTMLElement, canvas: wijmo.pdf.PdfPageArea, clientRect: wijmo.Rect, contentRect: wijmo.Rect, textTop: number, style: ICellStyle, getFormattedCell?: () => HTMLElement);
        /**
