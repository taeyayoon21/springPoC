...
declare module wijmo.grid.xlsx {
    ...
    function softTransGrid(): typeof wijmo.grid.transposed;
}
declare module wijmo.grid.xlsx {
    /**
    ...
    class FlexGridXlsxConverter {
         ...
         *  );</pre>
         */
        static saveAsync(grid: wijmo.grid.FlexGrid, options?: IFlexGridXlsxOptions, fileName?: string, onSaved?: (base64: string) => any, onError?: (reason?: any) => any, onProgress?: (value: number) => void): wijmo.xlsx.Workbook;
        /**
