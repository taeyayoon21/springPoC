...
declare module wijmo.odata {
    ...
    class ODataCollectionView extends wijmo.collections.CollectionView {
         ...
         *
         * For more details and a sample, see the {@link commitChanges} method.
         */
         ...
         *
         * The example below shows a typical use for the {@link deferCommits}
         * property and the {@link commitChanges} method:
         *
         * ```typescript
         * import { ODataCollectionView } from '@grapecity/wijmo.odata';
         *
         * // create the ODataCollectionView (TripPinService, OData V4)
         * // https://www.odata.org/blog/trippin-new-odata-v4-sample-service/
         * let url = 'https://services.odata.org/V4/(S(3vn0jej2dr3ebcgodm1zxcys))/TripPinServiceRW/';
         * let view = new ODataCollectionView(url, 'Airlines', {
         *     keys: ['AirlineCode'], // entity keys are required for write operations
         *     deferCommits: true
         * });
         *
         * // handle the commit changes button
         * document.getElementById('btn-commit').addEventListener('click', (e) => {
         *     let btn = e.target as HTMLInputElement;
         *     btn.disabled = true; // disable the button until done
         *     view.commitChanges((xhr: XMLHttpRequest) => {
         *         btn.disabled = false; // enable the button again when done
         *     });
         * });
         * ````
         *
