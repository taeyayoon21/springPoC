...
export declare class Globalize {
     ...
     * <b>r</b> Round-trip (same as g12): <code>formatNumber(0.1234, 'r') => '0.1234'</code>
...
export declare class CollectionView<T = any> implements IEditableCollectionView, IPagedCollectionView {
     ...
     * Occurs when the collection changes.
     */
    readonly collectionChanged: selfModule.Event<selfModule.CollectionView<T>, selfModule.NotifyCollectionChangedEventArgs<T>>;
    /**
     * Raises the {@link collectionChanged} event.
     *
     * @param e Contains a description of the change.
     ...
     */
    readonly sourceCollectionChanging: selfModule.Event<selfModule.CollectionView<T>, selfModule.CancelEventArgs>;
    /**
     ...
     */
    readonly sourceCollectionChanged: selfModule.Event<selfModule.CollectionView<T>, selfModule.EventArgs>;
    /**
     ...
     * Occurs after the current item changes.
     */
    readonly currentChanged: selfModule.Event<selfModule.CollectionView<T>, selfModule.EventArgs>;
    /**
     ...
     * Occurs before the current item changes.
     */
    readonly currentChanging: selfModule.Event<selfModule.CollectionView<T>, selfModule.CancelEventArgs>;
    /**
    ...
    * Occurs after the page index changes.
    */
    readonly pageChanged: selfModule.Event<selfModule.CollectionView<T>, selfModule.EventArgs>;
    /**
     ...
     * Occurs before the page index changes.
     */
    readonly pageChanging: selfModule.Event<selfModule.CollectionView<T>, selfModule.PageChangingEventArgs>;
    /**
